...
|------|--------| 
| **1. As a user, I want to see a friendly homepage with a responsive design.**<br><br>- [x] Create home page<br>- [x] Create background image<br>- [x] Basic project structure<br>- [x] Player placeholder sprite images | <div align="center"><img src="https://github.com/user-attachments/assets/e95e962f-1192-489b-8da4-8c191586a204" width="240" style="object-fit: cover;"> <img src="https://github.com/user-attachments/assets/b11df667-64fd-4b13-94dd-f6cddf057a30" width="240" hight="200" style="object-fit: cover;"></div><br>✔ The layout is fully responsive and displays correctly across multiple devices and modern browsers. | 
